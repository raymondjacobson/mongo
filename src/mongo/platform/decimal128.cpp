...
/**
  ...
  */
Decimal128::Decimal128(double d, Decimal128::RoundingModes roundMode) {
...
// 128 values directly (inexpensively)
  ...
  base10ExpInBID = bid128_scalbn(base10ExpInBID, base10Exp, roundMode,
                                 &_idec_signaling_flags);
  ...
  dec128 = bid128_quantize(dec128, quantizerReference, roundMode,
                           &_idec_signaling_flags);
...
const unsigned long long *Decimal128::getValue() const { return _value; }
void Decimal128::setValue(unsigned long long *ull) {
  _value[0] = ull[0];
  _value[1] = ull[1];
}

int Decimal128::toInt(Decimal128::RoundingModes roundMode) {
  ...
  case kRoundTowardNegative:
    return bid128_to_int32_floor(dec128, &_idec_signaling_flags);
  case kRoundTowardPositive:
    return bid128_to_int32_ceil(dec128, &_idec_signaling_flags);
  case kRoundTowardZero:
    return bid128_to_int32_int(dec128, &_idec_signaling_flags);
  case kRoundTiesAway:
    return bid128_to_int32_rninta(dec128, &_idec_signaling_flags);
  }
  // Mimic behavior of Intel library (if round mode not valid, assume default)
  return bid128_to_int32_rnint(dec128, &_idec_signaling_flags);
}
long Decimal128::toLong(Decimal128::RoundingModes roundMode) {
  BID_UINT128 dec128 = Decimal128ToLibraryType(_value);
  switch (roundMode) {
  case kRoundTiesToEven:
    return bid128_to_int64_rnint(dec128, &_idec_signaling_flags);
  case kRoundTowardNegative:
    return bid128_to_int64_floor(dec128, &_idec_signaling_flags);
  case kRoundTowardPositive:
    return bid128_to_int64_ceil(dec128, &_idec_signaling_flags);
  case kRoundTowardZero:
    return bid128_to_int64_int(dec128, &_idec_signaling_flags);
  case kRoundTiesAway:
    return bid128_to_int64_rninta(dec128, &_idec_signaling_flags);
  }
  // Mimic behavior of Intel library (if round mode not valid, assume default)
  return bid128_to_int64_rnint(dec128, &_idec_signaling_flags);
}
double Decimal128::toDouble(Decimal128::RoundingModes roundMode) {
  BID_UINT128 dec128 = Decimal128ToLibraryType(_value);
...
Decimal128 Decimal128::add(const Decimal128 &dec128,
                           Decimal128::RoundingModes roundMode) {
...
Decimal128 Decimal128::subtract(const Decimal128 &dec128,
                                Decimal128::RoundingModes roundMode) {
  BID_UINT128 current = Decimal128ToLibraryType(_value);
...
Decimal128 Decimal128::multiply(const Decimal128 &dec128,
                                Decimal128::RoundingModes roundMode) {
  BID_UINT128 current = Decimal128ToLibraryType(_value);
...
Decimal128 Decimal128::divide(const Decimal128 &dec128,
                              Decimal128::RoundingModes roundMode) {
  BID_UINT128 current = Decimal128ToLibraryType(_value);
...
Decimal128 Decimal128::quantize(const Decimal128 &reference,
  ...
  BID_UINT128 quantizedResult =
      bid128_quantize(current, q, roundMode, &_idec_signaling_flags);
  Decimal128 result;
