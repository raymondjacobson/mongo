 ...
 * uint32_t* signalingFlag : flag for signaling imprecise results
 */
BID_UINT128 quantizeTo15DecimalDigits(BID_UINT128 value,
    ...
    quantizerReference = bid128_scalbn(quantizerReference, base10Exp, roundMode, signalingFlag);

    value = bid128_quantize(value, quantizerReference, roundMode, signalingFlag);
    return value;
}
...
Decimal128::Decimal128(double doubleValue, RoundingMode roundMode) {
    ...
    _value = Decimal128Value(
        quantizeTo15DecimalDigits(convertedDoubleValue, roundMode, base10Exp, &throwAwayFlag).w);
    ...
    if (_value.low64 < 100000000000000ull || _value.low64 > 999999999999999ull) {
        ...
        if (base10Exp > 0)
            ...
            base10Exp++;
        _value = Decimal128Value(quantizeTo15DecimalDigits(
                                     convertedDoubleValue, roundMode, base10Exp, &throwAwayFlag).w);
    }
...
int32_t Decimal128::toInt(uint32_t* signalingFlag, RoundingMode roundMode) const {
    BID_UINT128 dec128 = decimal128ToLibraryType(_value);
    switch (roundMode) {
        case kRoundTiesToEven:
            return bid128_to_int32_rnint(dec128, signalingFlag);
        case kRoundTowardNegative:
            return bid128_to_int32_floor(dec128, signalingFlag);
        case kRoundTowardPositive:
            return bid128_to_int32_ceil(dec128, signalingFlag);
        case kRoundTowardZero:
            return bid128_to_int32_int(dec128, signalingFlag);
        case kRoundTiesToAway:
            return bid128_to_int32_rninta(dec128, signalingFlag);
        default:
            return bid128_to_int32_rnint(dec128, signalingFlag);
    }
}
...
int64_t Decimal128::toLong(uint32_t* signalingFlag, RoundingMode roundMode) const {
    BID_UINT128 dec128 = decimal128ToLibraryType(_value);
    switch (roundMode) {
        case kRoundTiesToEven:
            return bid128_to_int64_rnint(dec128, signalingFlag);
        case kRoundTowardNegative:
            return bid128_to_int64_floor(dec128, signalingFlag);
        case kRoundTowardPositive:
            return bid128_to_int64_ceil(dec128, signalingFlag);
        case kRoundTowardZero:
            return bid128_to_int64_int(dec128, signalingFlag);
        case kRoundTiesToAway:
            return bid128_to_int64_rninta(dec128, signalingFlag);
        default:
            return bid128_to_int64_rnint(dec128, signalingFlag);
    }
}
...
int32_t Decimal128::toIntExact(uint32_t* signalingFlag, RoundingMode roundMode) const {
    BID_UINT128 dec128 = decimal128ToLibraryType(_value);
    switch (roundMode) {
        case kRoundTiesToEven:
            return bid128_to_int32_xrnint(dec128, signalingFlag);
        case kRoundTowardNegative:
            return bid128_to_int32_xfloor(dec128, signalingFlag);
        case kRoundTowardPositive:
            return bid128_to_int32_xceil(dec128, signalingFlag);
        case kRoundTowardZero:
            return bid128_to_int32_xint(dec128, signalingFlag);
        case kRoundTiesToAway:
            return bid128_to_int32_xrninta(dec128, signalingFlag);
        default:
            return bid128_to_int32_xrnint(dec128, signalingFlag);
    }
}
...
int64_t Decimal128::toLongExact(uint32_t* signalingFlag, RoundingMode roundMode) const {
    BID_UINT128 dec128 = decimal128ToLibraryType(_value);
    switch (roundMode) {
        case kRoundTiesToEven:
            return bid128_to_int64_xrnint(dec128, signalingFlag);
        case kRoundTowardNegative:
            return bid128_to_int64_xfloor(dec128, signalingFlag);
        case kRoundTowardPositive:
            return bid128_to_int64_xceil(dec128, signalingFlag);
        case kRoundTowardZero:
            return bid128_to_int64_xint(dec128, signalingFlag);
        case kRoundTiesToAway:
            return bid128_to_int64_xrninta(dec128, signalingFlag);
        default:
            return bid128_to_int64_xrnint(dec128, signalingFlag);
    }
}
...
double Decimal128::toDouble(uint32_t* signalingFlag, RoundingMode roundMode) const {
    BID_UINT128 dec128 = decimal128ToLibraryType(_value);
    return bid128_to_binary64(dec128, roundMode, signalingFlag);
}
...
std::string Decimal128::toString() const {
    ...
    uint32_t discardFlag = 0;
    bid128_to_string(c.get(), dec128, &discardFlag);
...
Decimal128 Decimal128::add(const Decimal128& other,
    ...
    current = bid128_add(current, addend, roundMode, signalingFlag);
...
Decimal128 Decimal128::subtract(const Decimal128& other,
    ...
    current = bid128_sub(current, sub, roundMode, signalingFlag);
    Decimal128::Decimal128Value value(current.w);
    Decimal128 result(value);
    return result;
}
...
Decimal128 Decimal128::multiply(const Decimal128& other,
    ...
    current = bid128_mul(current, factor, roundMode, signalingFlag);
    Decimal128::Decimal128Value value(current.w);
    Decimal128 result(value);
    return result;
}
...
Decimal128 Decimal128::divide(const Decimal128& other,
    ...
    current = bid128_div(current, divisor, roundMode, signalingFlag);
    Decimal128::Decimal128Value value(current.w);
    Decimal128 result(value);
    return result;
}
...
Decimal128 Decimal128::quantize(const Decimal128& reference,
    ...
    BID_UINT128 quantizedResult = bid128_quantize(current, q, roundMode, signalingFlag);
