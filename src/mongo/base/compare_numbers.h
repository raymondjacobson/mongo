...
namespace mongo {
    ...
    /** Comparisons between other types and decimal types are potentially difficult.
     * These following cases need support (this notation keeps lhs always a decimal):
